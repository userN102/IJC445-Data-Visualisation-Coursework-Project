...
# Extract enterprise death counts by SIC industry and year
# Source: ONS Business Demography Excel file (ons_original.xlsx), Table 2.2
# Output: Long-format dataset (industry_code × year) for exit-rate calculation

# Data source (provided ONS Excel file)
file_path <- "./Dataset/ONS_Business_Demography/ons_original.xlsx"


# Read Table 2.2, skipping metadata rows added by ONS Excel formatting
...
# Save output for merging with births and active enterprises to compute exit rates
write.csv(
  df_long,
